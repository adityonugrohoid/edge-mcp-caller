...
- **Training data**: Synthetic generation via Claude API
...
## Key Files
- `data/generate_dataset.py` — Synthetic training data generation via Claude API
...
- Synthetic data generated by Claude API with diversity constraints
